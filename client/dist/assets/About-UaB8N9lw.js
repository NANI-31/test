import{G as Y,r as H,g as ee,a as $,u as te,j as t,c as B,m as D}from"./index-yfX6QFFA.js";function ne(u){return Y({attr:{viewBox:"0 0 24 24",fill:"currentColor"},child:[{tag:"path",attr:{d:"M12 0.5L16 8L23.5 12L16 16L12 23.5L8 16L0.5 12L8 8L12 0.5Z"},child:[]}]})(u)}var j={},V;function ae(){if(V)return j;V=1;function u(i){if(typeof window>"u")return;const c=document.createElement("style");return c.setAttribute("type","text/css"),c.innerHTML=i,document.head.appendChild(c),i}Object.defineProperty(j,"__esModule",{value:!0});var e=H();function g(i){return i&&typeof i=="object"&&"default"in i?i:{default:i}}var n=g(e);u(`.rfm-marquee-container {
  overflow-x: hidden;
  display: flex;
  flex-direction: row;
  position: relative;
